  ...
  const eventContent = (eventInfo) => {
    return (
      <div className="flex justify-between  z-10 mt-2 ">
        <div>
          <p className="!text-[#434343] z-30 bg-red-10">
          ...
          <div>
            <div className="bg-white relative py-[3.2rem] mt-6">
              <div className="w-[40%] ps-8  ">
                ...
                <Typography component="h5">{t("Appointment.1")}</Typography>
              </div>
              <img
                src={Docter}
            ...
            <div className="flex justify-between mt-10">
              ...
              <div className="w-[40%] bg-white px-4 pt-5 rounded-md shadow-md">
                <Typography component="h3" className="!text-[#2F4050]">
                  {t("Appointment.2")}
                </Typography>
                <div>
                  {/* must use map  */}
                  <div className="flex   mt-5 justify-between items-center ">
                    <div className="flex items-center gap-5">
                      ...
                      <div className="">
                        <Typography component="h4" className="!text-[#2f4050]">
                          Reem Basel - Kidney Transplant{" "}
                        </Typography>
                        <span className="text-[12px] text-myGray-500 mr-2">
                          Sep 12, 2023
                        </span>
                        <span className="text-[12px] text-myGray-500">
                          09:00 - 11:00 am{" "}
                        </span>
                      </div>
                    </div>
