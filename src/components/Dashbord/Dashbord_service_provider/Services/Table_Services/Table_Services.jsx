...
import product from "../Table_Services/Services_img/product.svg";
import left from "../Table_Services/Services_img/left.svg";
import right from "../Table_Services/Services_img/right.svg";
              ...
              <div className="w-[17rem] sm:w-[22rem] md:w-[36rem] pb-5 bg-white absolute top-32 end-0 sm:end-5 rounded shadow z-20 px-4 md:px-8 ">
                <div className="py-5 md:py-10 flex flex-col gap-3">
                  ...
                  <Typography component={"h5"}>
                    {t("editServices.1")}: 10/27/2023 11:34,{" "}
                    {t("editServices.2")}
                  </Typography>
                </div>
