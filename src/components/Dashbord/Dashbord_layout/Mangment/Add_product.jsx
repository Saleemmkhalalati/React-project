              ...
              <form onSubmit={formik.handleSubmit} className="relative space-y-5 ">
                      ...
                      <div className="flex justify-between items-center " key={index}>
                        {
                          input.input_type === "dropdown" ?
                            <div className="w-full flex items-center justify-between   h-[2.3rem] ease-in-out  border-[1px] rounded-md text-mySlate  border-myGray-400">
                              <span className=" ps-2 absolute h-[2rem]">{input.text}</span>
                ...
                {Add_Product_content.other && (
                  <div className="flex items-center gap-2">
                    ...
                    <Typography className={"!text-error cursor-pointer"}>{Add_Product_content.other.des}</Typography>
                  </div>
                )}
