    ...
    const Menus = [
        {
            ...
            Data: [
                ...
                { title:t("sideBar_Dashbord.about_users_menu.2"), src: "/dashboard/requests", icon: person_pluse },
                { title: t("sideBar_Dashbord.about_users_menu.3"), src: "/dashboard/report", gap: true, icon: Graph },
                { title: t("sideBar_Dashbord.about_users_menu.4"), src: "/dashboard/notifications", icon: Notification },
            ],
        },
        {
        ...
        <div className=" h-screen  flex justify-center flex-wrap  py-5 px-10 w-[20%]  ">
            ...
            >
                ...
                <div className="flex grident  px-5 py-2 items-center gap-5  rounded-[8px] w-full ">
                    ...
                    <p className="text-white hidden lg:block">{ t("sideBar_Dashbord.main_title.0")}</p>
                </div>
          ...
          ${data.gap ? "mt-9" : "mt-2"}  `}
                                        ...
                                        >
                                            <NavLink to={`${data.src}`} className='flex justify-between gap-5   p-2 w-full h-full '>

                                                <div style={{ backgroundImage: `url(${data.icon})` }} alt="" className="w-5 h-5 icon-menue bg-no-repeat bg-cover bg-center" >
                                                ...
                                                <ul className=" hidden lg:block">
                                                    {data.subMenus.map(
                                                        (subMenuItem, idx) => (
                                                            ...
                                                            >
                                                                <NavLink to={`${data.src}/${subMenuItem.src}`} className='flex justify-between gap-5 lg:block'>
                                                                    {
                                                                        subMenuItem.title
                                                                    }
                                                                </NavLink>
