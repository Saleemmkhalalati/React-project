...
const Allservices = () => {
  ...
  return (
   ...
   <CircleChart title= {t("report_admin_page.department.1")}  />
   <Chart data={userData} yuserData={yuserData} title= {t("report_admin_page.department.1")}   dec={t("report_admin_page.chart_des.1")} grid dataKey="Active User" />
