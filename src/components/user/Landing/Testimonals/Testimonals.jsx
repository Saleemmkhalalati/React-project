        ...
        <section className={`testimonals_section overflow-hidden  relative   sm:px-16 px-6 sm:py-36 py-10`}>
            ...
            <div className="flex flex-col lg:flex-row justify-around items-center  py-10 ">
                <div className="testimonals_images  mt-20   ">
                    <div className='mt-10 '>
                        {/* testimonals 2 +4 */}
                        <div className={`flex  row-image gap-14  rtl:translate-x-0 rtl:w-full  md:gap-24 lg:gap-16 lg:justify-between cursor-pointer w-[450px] lg:translate-x-1 md:translate-x-1 md:mt-2  md:translate-y-5 lg:translate-y-0  translate-y-[-100px] translate-x-[110px] rtl:md:translate-y-[10px]`}>
                            ...
                            <div onClick={() => { showInfo(4) }} className={` z-10 rotate-[46deg]   bg-myGray-100 w-[100px] h-[100px]  md:w-[200px] md:h-[200px]  lg:w-[200px] lg:h-[200px] rounded-[5px]  ${pactive !== 4 ? "opacity-[25%]  grident" : " scale-110 grident !opacity-[80%]"} `}>
                                <div className="  w-full h-full relative overflow-hidden">
                                    ...
                                    < p className=' z-20 text-white rotate-[-40deg] w-full  text-[12px] md:w-[70%] absolute lg:left-[50%] lg:bottom-[20%] md:left-[50%]    left-1 bottom-10 md:text-[16px]'>Eleanor Pena</p>
                            ...
                            <div onClick={() => { showInfo(2) }} className={` bg-myGray-100  w-[100px] h-[100px]  z-10 rotate-[46deg] md:w-[180px] md:h-[180px]  lg:w-[180px] lg:h-[180px] rounded-[5px]  ${pactive !== 2 ? "opacity-[25%]  z-10 grident" : " scale-110   grident !opacity-[80%]"}`}>
                                <div className=" opacity-[60%] w-full h-full relative overflow-hidden">
                                    ...
                                    < p className=' z-20 text-white rotate-[-40deg] w-full  text-[12px] md:w-[70%] absolute lg:left-[50%] lg:bottom-[20%] md:left-[50%]    left-1 bottom-10 md:text-[16px]'>Jackie Prankline</p>
                        ...
                        <div className={`flex col-iamge  lg:gap-[100px]    md:gap-24 rotate-[90deg]  gap-12  lg:translate-y-[-190px] translate-y-[-100px]  md:translate-y-[-180px] cursor-pointer translate-x-3 rtl:translate-y-[-200px] rtl:translate-x-[-2px] rtl:md:translate-x-[-10px] rtl:md:gap-28`}>
                            {/* t1 */}
                            <div onClick={() => { showInfo(1) }} className={` bg-myGray-100    z-10 rotate-[46deg]   w-[100px] h-[100px]  md:w-[180px] md:h-[180px]  lg:w-[180px] lg:h-[180px] rounded-[5px]    ${pactive !== 1 ? "!opacity-[25%]  z-10 grident" : " scale-110 grident !opacity-[80%]"}`}>
                                <div className="  opacity-[100%] w-full h-full relative overflow-hidden">
                                    <img src={`${testmonal_1}`} alt="" className='rotate-[-140deg]  md:w-[500p] md:h-[300px] absolute md:bottom-[-20px] md:left-16 bottom-0 left-5 ' />
                                    < p className=' z-20 text-white rotate-[-135deg] w-full  text-[12px] md:w-[70%] absolute lg:left-[30%] lg:bottom-[60%] md:left-[50px] md:bottom-24   left-1 bottom-10 md:text-[16px]'>One of the pioneers of the site</p>
